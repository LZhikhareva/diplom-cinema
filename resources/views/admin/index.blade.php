...
<body>
    ...
    <form action="/admin/halls" id="hall_update" method="post">
      ...
      @endforeach
          ...
          <div class="conf-step__legend">
            <label class="conf-step__label">Рядов, шт
              <input type="text" class="conf-step__input rows" placeholder="2"
                onkeydown="if(event.keyCode==13){return false;}" />
            </label>
            <span class="multiplier">x</span>
            <label class="conf-step__label">Мест, шт
              <input type="text" class="conf-step__input cols" placeholder="3"
                onkeydown="if(event.keyCode==13){return false;}" />
            </label>
          </div>
      ...
      <section class="conf-step">
        ...
        <div class="conf-step__wrapper">
          ...
          <ul class="conf-step__selectors-box">
            @foreach ($halls as $hall)
        <li><input type="radio" class="conf-step__radio" name="chairs-hall1" value="{{ $hall->id}}" checked><span
      ...
      @endforeach
          ...
          <div class="conf-step__legend">
            <label class="conf-step__label">Цена, рублей<input type="text" class="conf-step__input vip_price"
                placeholder="0"></label>
  ...
  <script src="/js/admin/addHall.js"></script>
  <script src="/js/admin/deleteHall.js"></script>
  <script type="module" src="/js/admin/resizeHall.js"></script>
  <script type="module" src="/js/admin/hallConfigurate.js"></script>
  <script src="/js/admin/addMovie.js"></script>
  <script src="/js/admin/deleteMovie.js"></script>
