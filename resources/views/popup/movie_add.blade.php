      ...
      <div class="popup__wrapper">
        <form action="/admin/add-movie" method="post" accept-charset="utf-8" id="addMovie"
          ...
          <label class="conf-step__label conf-step__label-fullsize" for="duration">
            ...
            <input class="conf-step__input" id="movie-dur" type="text" placeholder="Например, &laquo;120&raquo;"
              name="duration" required>
          </label>

          <label class="conf-step__label conf-step__label-fullsize" for="description">
            Описание фильма
            <input class="conf-step__input" id="movie-description" type="text" placeholder="Описание фильма"
          ...
          <input class="conf-step__input" id="movie-poster" type="file" name="poster" accept="image/*"
            style="display: none;" />
          <div style="margin-top: 10px;">
            <img id="posterPreview" alt="Превью постера"
              style="display:none; max-width: 200px; max-height: 300px; border: 1px solid #ccc;" />
          </div>
          <div class="alert"></div>
          <div class="conf-step__buttons text-center">
            <input type="submit" value="Добавить фильм" class="conf-step__button conf-step__button-accent">
            <label for="movie-poster" class="conf-step__button conf-step__button-accent" style="cursor: pointer;">
              Загрузить постер
            </label>
...
<script>
  document.getElementById('movie-poster').addEventListener('change', function (event) {
